...
const KNOWN_SFX_EVENTS := [
	...
	SFX_EVENT_BONUS_ADD_BALL_APPLY,
	SFX_EVENT_BONUS_DESTROY_BALL_APPLY,
	SFX_EVENT_BONUS_JUMP_LEVEL_APPLY,
...
const SFX_EVENT_NAMES := {
	...
	SFX_EVENT_EPISODE_ACTIVATE: "eff03",
	...
	SFX_EVENT_BONUS_ADD_BALL_APPLY: "eff17",
	SFX_EVENT_BONUS_DESTROY_BALL_APPLY: "eff24",
	SFX_EVENT_BONUS_JUMP_LEVEL_APPLY: "eff19",
